...
class ScheduledVaccineTest {
    ...
    void addAppointmentToSlotWithNoAvailability() {
        ...
        ScheduledVaccineDto scheduledVaccineDto1 = new ScheduledVaccineDto();
        ScheduledVaccineDto scheduledVaccineDto2 = new ScheduledVaccineDto();
        VaccinationCenter vaccinationCenter = new VaccinationCenter("test", "test", "911111111", "test@gmail.com", "911111111", "www.test.com", "9", "16", "30", "1", "test", "4470-111", "test", company.getCentreCoordinatorList().get(0).getId());
        company.getVaccinationCenters().add(vaccinationCenter);
