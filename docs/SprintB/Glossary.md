...
| **Mass Vaccination Center** | **Centro de Vacinação em Massa** | Mass vaccination centes are similar to healthcare centers but usually only administer one type of vaccine during pandemic events. |
