...
| **Application User** | **Utilizador da Aplicação** | ---- |
...
| **Entries and Exits List** | **Lista de Entradas e Saídas** | ---- |
...
| **Given Vaccine** | **Vácina administrada** | ---- |
| **Healthcare Center** | **Centro de cuidados de saúde* | ---- |
| **JUnit5** | **JUnit5** | ---- |
| **JaCoCo**| **JaCoCo** | ---- |
| **JavaFX 11** | **JavaFX 11** | ---- |
| **Javadoc** | **Javadoc** | ---- |
| **Mass Vaccination Center** | **Centro de Vacinação em Massa** | ---- |
...
| **Type of Vaccine** | **Tipo de Vácina** | ---- |
| **User Info** | **Informação do Utilzador** | ---- |
| **User Waiting List** | **Lista de espera de Utilizadores** | ---- |
| User | Utilizador | A person who uses or operates something. |
| **Vaccination Center** | **Centro de Vacinação** | ---- |
| **Vaccination Process** | **Processo de Vacinação** | ---- |
| **Vaccine Appointment** | **Agendamento de Vacinas** | ---- |
